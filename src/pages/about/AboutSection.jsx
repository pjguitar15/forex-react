...
const AboutSection = () => {
  ...
  return (
    <>
          ...
          <div className='col-md-7 px-md-5 mt-4 mt-md-0'>
            ...
            >
              ...
              <div className='mt-3' style={{ color: '#c9c9c9' }}>
                ...
                transformation and shaping an empowered future for the citizens
                of South Africa. It has made sizeable investments in
                opportunities to drive positive change in South Africa’s
      ...
      <div className='gradient-line col-12' style={{ height: '5px' }}></div>
    </>
  )
}
