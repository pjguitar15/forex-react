...
const Register = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      await addDoc(collectionRef, {
        ...
        email: email,
        isIdDocumentApproved: false,
        isProofOfAddressApproved: false,
        isPictureWithIdApproved: false,
  ...
  useEffect(() => {
    ...
    if (password.length < 6) {
      setPasswordStrength('Poor. Password length must be 6 characters above.')
    } else if (
      isSymbolIncluded &&
      isNumberIncluded &&
  ...
  return (
    <div className='row rubik-400 px-5' style={{ background: '#0c0c0c' }}>
      <div className='col-lg-7 col-xl-6 py-5 px-3'>
        ...
        >
          ...
          <Form.Group className='py-2 rubik-400'>
            ...
            <div
              className={`small rubik-400 ${
                ...
                passwordStrength ===
                  'Poor. Password length must be 6 characters above.'
                  ? 'text-danger'
                  : ''
              } ${
                passwordStrength ===
          ...
          <Form.Group className='pt-3'>
            ...
            >
              {submitButtonLoading ? 'Signing you up...' : 'Register'}
            </Button>
          </Form.Group>
          <Button
            variant='black'
            ...
            size='sm'
            className='rubik-400 mt-2 col-12 bg-none text-light'
          >
      ...
      <div className='col-lg-5 col-xl-6 text-light p-5'>
        ...
        <div className='my-5'>
          ...
          <p>
            To meet our obligations, we need to confirm your identity. This can
        ...
        <div className='my-5'>
          ...
          <p>
            Use one of our fast, flexible and secure payment methods to deposit
            funds into your trading account
          </p>
          <hr />
        </div>
        <div className='mb-3' style={{ height: '19rem' }}>
          <img
