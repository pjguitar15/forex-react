...
const TopButtons = () => {
  ...
  return (
    <>
      <div className='col-12 w-100 mx-auto d-flex justify-content-between my-4'>
        <h2 className='m-0 text-dark bg-light p-3 lead border border-warning border-3 px-4 manrope-600'>
          Segment:
          <div className='fw-bold display-5 text-black'>
      ...
      <div className='text-start'>
        ...
        <Button
          variant={`${
            location.pathname === '/fica-documents' ? 'light' : 'outline-light'
          }`}
          className='rubik-400 me-1 my-1 rounded-0 border-0'
          size='sm'
